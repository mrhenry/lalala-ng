...
}(this, function (moment)
{
    ...
    renderTimePicker = function(calendar)
    {
        ...
        for (var i=1; i<24; i++) {
            ...
            strSelected = strTime + ':00' === calendar._strTime ? ' selected' : '';
            htmlTable += '<option value="' + strTime + ':00" ' + strSelected + '>' + strTime + ':00</option>';
            strSelected = strTime + ':30' === calendar._strTime ? ' selected' : '';
            htmlTable += '<option value="' + strTime + ':30" ' + strSelected + '>' + strTime + ':30</option>';
        }
